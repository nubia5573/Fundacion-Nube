...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2023 a las 16:02:33
...
(3, 'TWFyaWE=', 'Maria', 55200373, 'Huertas');
...
(33, 'Canela', 10, 'negro', 'chiguagua', 'pequeno', '7.jpg', 'perro'),
(34, 'Mateo', 16, 'gris', 'criolla', 'mediano', '8.jpg', 'perro'),
...
(7, 'Miguel', 'Acevedo', '3218789090', 'mcastro@gmail.com', 'informacion', 'Quiero hacer una donación', 0);
...
--
ALTER TABLE `administrador`
  MODIFY `admId` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `solicitud`
  MODIFY `idSolicitud` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
